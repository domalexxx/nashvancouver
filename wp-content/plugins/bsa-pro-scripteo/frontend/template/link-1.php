...
// -- START -- TEMPLATE HTML
	...
	echo '<div class="bsaProItems '.bsa_space($sid, "grid_system").' '.((bsa_space($sid, "display_type") == 'carousel') ? 'bsa-owl-carousel bsa-owl-carousel-'.$sid : '').'" style="background-color:'.bsa_space($sid, 'ads_bg').'; border-color:'.bsa_space($sid, 'ad_extra_color_1').'">'; // -- START -- ITEMS
