...
// -- START -- TEMPLATE HTML
	...
	foreach ( $ads as $key => $ad ) {
		...
		echo '<div class="bsaProItemInner__img" style="background-image: url(&#39;'.bsa_crop_tool($crop, ((!isset($sid) && !isset($_POST['bsa_ad_id']) || isset($example)) ? $ad['img'] : bsa_upload_url().$ad['img']), 250, 150).'&#39;)"></div>'; // -- ITEM -- IMG
