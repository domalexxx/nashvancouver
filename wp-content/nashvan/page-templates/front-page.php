...
<?php printf( _x('%s ago','%s= human-readable time difference','clickwebstudio' ),human_time_diff(get_the_time('U'), current_time('timestamp'))); ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <ul class="events">
		  <?php
			query_posts(array('post_type'=>'event','post_status'=>'publish','posts_per_page'=>'1'));
			if(have_posts())
			  {
			   while(have_posts())
				{
