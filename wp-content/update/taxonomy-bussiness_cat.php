...
?>
<div class="container business-directory inside">
	<div class="row">
		<?php get_sidebar(); ?>
		<?php
			$str = "";
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="row">
						<div class="row col-xs-4 col-sm-4 col-md-4 col-lg-4">
						 ...
						 ?>
							<select name="mrbusiness_category" id="mr-selectbus-category" class="form-control" required>
					...
					<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								 ...
								 query_posts(array('post_type'=>'business','s'=>$str,'post_status'=>'publish','posts_per_page'=>$postPerPage,
									'tax_query' => array(
									array(
