  ...
  <div class="row">
	<?php get_sidebar(); ?>
	  ...
	  <?php foreach($categories as $category) { ?>
		  ...
		  <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 padding-right-empty">
			<div class="mr-catpost-outer" id="mr-catpost-outer-<?php echo $i; ?>">
				...
				<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-right-empty">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 main-image">
						<?php
					...
					<?php
						...
						if( $my_query->have_posts() ) {
							...
							while ($my_query->have_posts()) : $my_query->the_post();
								...
								echo '<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 small-image">';
				...
				<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-right-empty new-row">
					<?php
						/* Next three posts */
