<?php 
/* Template Name: About Vancouver Templates */
 ?>
...
<div id="main-container" class="container all-news">
  <div class="row top-buffer2">
	  ...
	  <?php $categories = get_terms( 'category', array('include' => get_post_meta( $post->ID, 'select_category', true)) ); $i=1; ?>
					...
					<?php
						...
						if( $my_query->have_posts() ) {
							...
							while ($my_query->have_posts()) : $my_query->the_post();
								...
								echo '<h1>'. mb_strimwidth(get_the_title(),0,50,'...').'</h1>';
