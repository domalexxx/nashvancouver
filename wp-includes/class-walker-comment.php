		...
		<div class="comment-author vcard">
			<div class="row">
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-10 text-left">
							<?php printf( __( '<span class="fn">%s</span>' ), get_comment_author_link( $comment ) ); ?>
							<div class="comment-meta commentmetadata">
								<span class="comment-time"><?php echo get_comment_time('g:i A'); ?></span>
								<span class="comment-date"><?php echo get_comment_date( 'j F Y', $comment ); ?></span>
								<?php
							...
							<ul class="vote">
								<li class="upvote">
									<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/upvote.png"></a>
									<span>12</span>
								</li>
								<li class="downvote">
									<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/downvote.png"></a>
									<span>2</span>
								</li>
							</ul>
							</div>
